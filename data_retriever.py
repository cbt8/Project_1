...
dhs = {
    'table1':pd.read_excel("./data/fy2017_table1.xlsx", header=3, skipfooter=2, na_values=['-','D']),
    'table2':pd.read_excel("./data/fy2017_table2.xlsx",header=3 ,skipfooter=24, na_values=['-','D']),
    'table3':pd.read_excel("./data/fy2017_table3d.xlsx",header=3 ,skipfooter=6, na_values=['-','D']),
    'table4':pd.read_excel("./data/fy2017_table4.xlsx",header=3, skipfooter=3, na_values=['-','D']),
    'table5':pd.read_excel("./data/fy2017_table5.xlsx", header=3, skipfooter=2, na_values=['-','D']),
    'table6':pd.read_excel("./data/fy2017_table6.xlsx",header=3, skipfooter=4, na_values=['-','D']),
    'table7':pd.read_excel("./data/fy2017_table7d.xlsx",header=3, skipfooter=3, na_values=['-','D']),
    'table8':pd.read_excel("./data/fy2017_table8.xlsx",header=3, skipfooter=2, na_values=['-','D']),
    'table9':pd.read_excel("./data/fy2017_table9d.xlsx", header=3, skipfooter=3, na_values=['-','D']),
    'table10':pd.read_excel("./data/fy2017_table10d.xlsx", header=3, skipfooter=4, na_values=['-','D']),
    'table11':pd.read_excel("./data/fy2017_table11d.xlsx", header=3, skipfooter=4, na_values=['-','D']),
    'table12':pd.read_excel("./data/fy2017_table12d.xlsx", header=3, skipfooter=4, na_values=['-','D']),
    'table13':pd.read_excel("./data/fy2016_table13.xls", header=3, skipfooter=2, na_values=['-','D']),
    'table14':pd.read_excel("./data/fy2016_table14d.xls", header=3, skipfooter=7, na_values=['-','D']),
    'table15':pd.read_excel("./data/fy2016_table15d.xls", header=3, skipfooter=4, na_values=['-','D']),
    'table16':pd.read_excel("./data/fy2016_table16.xls", header=3, skipfooter=1, na_values=['-','D']),
    'table17':pd.read_excel("./data/fy2016_table17d.xls", header=3, skipfooter=5, na_values=['-','D']),
    'table18':pd.read_excel("./data/fy2016_table18d.xls", header=3, skipfooter=5, na_values=['-','D']),
    'table19':pd.read_excel("./data/fy2016_table19d.xls", header=3, skipfooter=5, na_values=['-','D']),
    'table20':pd.read_excel("./data/fy2017_table20.xlsx", header = 5, skipfooter=6, na_values=['-','D']),
    'table21':pd.read_excel("./data/fy2017_table21d.xlsx", header = 3, skipfooter=6, na_values=['-','D']),
    'table22':pd.read_excel("./data/fy2017_table22.xlsx", header = 3, skipfooter=3, na_values=['-','D']),
    'table23':pd.read_excel("./data/fy2017_table23.xlsx", header=4, skipfooter=2, na_values=['-','D']),
    'table24':pd.read_excel("./data/fy2017_table24.xlsx", header=4, skipfooter=3, na_values=['-','D']),
    'table25':pd.read_excel("./data/fy2017_table25d.xlsx", header=2, skipfooter=10, na_values=['-','D']),
    'table26':pd.read_excel("./data/fy2017_table26d.xlsx", header=3, skipfooter=16, na_values=['-','D']),
    'table27':pd.read_excel("./data/fy2017_table27d.xlsx", header=3, skipfooter=9, na_values=['-','D']),
    'table28':pd.read_excel("./data/fy2017_table28d.xlsx", header=3, skipfooter=20, na_values=['-','D']),
    'table29':pd.read_excel("./data/fy2017_table29.xlsx", header=3, skipfooter=8, na_values=['-','D']),
    'table30':pd.read_excel("./data/fy2017_table30.xlsx", header=3, skipfooter=9, na_values=['-','D']),
    'table31':pd.read_excel("./data/fy2017_table31.xlsx", header=3, skipfooter=8, na_values=['-','D']),
    'table32':pd.read_excel("./data/fy2017_table32d.xlsx", header=3, skipfooter=16, na_values=['-','D'])
    }
...
bp = {
    'table1': pd.read_csv("./data/bp-yearly-apprehensions.csv")
}
bp_descriptions = {
